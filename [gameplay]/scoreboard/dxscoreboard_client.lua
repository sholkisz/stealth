...
function doDrawScoreboard( rtPass, onlyAnim, sX, sY )
	...
	if #scoreboardColumns ~= 0 then
		...
		if scoreboardDrawn then
			...
			dxDrawText("MTA STEALTH TOURNAMENT 2026",topX+s(10),y,topX+scoreboardDimensions.width-(10),y+s(20),tocolor(255,255,255,255),fontscale(contentFont, s(0.8)), contentFont,"right","center",true)
		end
	end
end
